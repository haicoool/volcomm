...
@section('content')
    <div class="px-8"> <!-- Added padding to the left and right -->
        <h1 class="text-3xl font-bold mb-6 text-gray-800">Organizations</h1>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                                ...
                                <form action="{{ route('admin.organizations.terminate', $organization->organizationId) }}" 
                                      method="POST" style="display:inline;" class="terminate-form">
                                    @csrf
                                    @method('DELETE')
    ...
    <!-- Include Material Icons for better button UX -->
