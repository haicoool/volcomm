            ...
            @foreach($opportunities as $opportunity)
                <tr class="border-b hover:bg-gray-100">
                    ...
                    <td class="py-4 px-4 text-center">
                        <a href="{{ route('registrations.show', $opportunity->oppId) }}" class="inline-block px-4 py-2 text-white bg-blue-600 rounded hover:bg-blue-700 transition duration-300">View Volunteer List</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
