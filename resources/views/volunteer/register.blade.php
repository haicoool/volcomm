...
<div class="max-w-xl mx-auto mt-10 bg-white p-8 rounded-lg shadow-lg relative">
    ...
    <form method="POST" action="{{ route('volunteer.register') }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="vSkill" id="vSkill" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
        </div>
